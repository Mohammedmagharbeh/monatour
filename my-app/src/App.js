...
//         <header className="bg-gradient-to-r from-blue-900 to-blue-800 text-white shadow-lg">
//           <div className="container mx-auto px-4 py-6 text-center">
//             <h1 className="text-3xl font-bold">مؤسسة الناطور للمواد الصحية</h1>
//             <p className="text-blue-200 mt-2">نظام إدارة المخازن والحسابات</p>
//           </div>
//         </header>
...
//           <div className="container mx-auto px-4 py-6 text-center">
//             <p className="text-gray-400 text-sm">
//               © {new Date().getFullYear()} مؤسسة الناطور للمواد الصحية. جميع
//               الحقوق محفوظة.
//             </p>
//             <p className="text-gray-500 text-xs mt-2">
//               نظام إدارة متكامل - نسخة 1.0
