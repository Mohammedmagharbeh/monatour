...
//     const res = await axios.get("http://localhost:5000/api/warehouse2");
//     setItems(res.data);
//   };
...
//       );
//     } else {
//       await axios.post("http://localhost:5000/api/warehouse2", form);
//     }
...
//     await axios.delete(`http://localhost:5000/api/warehouse2/${id}`);
//     fetchItems();
//   };
...
const Warehouses = () => {
  ...
  // 🔹 رابط الباك أند الجديد للمستودع الثاني
  const API_URL = "https://monatour-3.onrender.com/api/warehouse2";
  ...
  // حساب الإجمالي لكل المستودع الثاني
  const totalAmount = items.reduce(
    (sum, item) => sum + item.quantity * item.price,
    0
  );
