...
const Warehouses = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (editingId) {
      await axios.put(`https://monatour-3.onrender.com/api/warehouse2/${editingId}`, form);
    } else {
      await axios.post("https://monatour-3.onrender.com/api/warehouse2", form);
    }
    setForm({ name: "", quantity: "", price: "" });
    setEditingId(null);
    fetchItems();
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4">جرد المستودع الثاني</h1>
